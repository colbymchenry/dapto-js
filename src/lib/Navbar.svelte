        ...
        <div class="nav__container">
            <div class="nav__header">
                <button type="button" class="nav-button-back js-nav-back">
                    <i class="icon" data-feather="arrow-left-circle" />
                </button>

                <button type="button" class="nav-btn-close js-nav-close pointer-events-none">
                    <i class="icon" data-feather="x" />
                </button>
            </div>
                ...
                <div class="nav__content__left">
                    <div class="navList__wrap">
                        <ul class="navList js-navList">
                            <li>
                                <a data-barba href="#"> Classic Menu </a>
                            </li>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="subnav-list">
                                    <li>
                                        <a data-barba href="#">Main Slider</a>
                                    </li>
                                    <li>
                                        <a data-barba href="#">Main Dark</a>
                                    </li>
                                    <li>
                                        <a data-barba href="#">Simple Slider</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="subnav-list">
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="subnav-list">
                                            <li>
                                                <a data-barba href="#">About 1</a>
                                            </li>
                                            <li>
                                                <a data-barba href="#">About 2</a>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="subnav-list">
                                            <li>
                                                <a data-barba href="#">Services 1</a>
                                            </li>
                                            <li>
                                                <a data-barba href="#">Services 2</a>
                                            </li>
                                        </ul>
                                    </li>
